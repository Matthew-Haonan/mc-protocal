...
#ifndef _MC_RTU_PRIVATE_H_
#define _MC_RTU_PRIVATE_H_
...
#define _MC_RTU_HEADER_LENGTH      1
#define _MC_RTU_PRESET_REQ_LENGTH  6
#define _MC_RTU_PRESET_RSP_LENGTH  2

#define _MC_RTU_CHECKSUM_LENGTH    2
