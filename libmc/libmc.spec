...
Version: 3.0.6
Release: 1%{?dist}
Summary: A Mc library
Group: Applications/System
License: LGPLv2+
URL: http://www.libmc.org/
Source0: https://github.com/downloads/stephane/libmc/libmc-%{version}.tar.gz
BuildRequires: autoconf, automake, libtool, xmlto, asciidoc

%description
libmc is a C library designed to provide a fast and robust implementation of
the Mc protocol. It runs on Linux, Mac OS X, FreeBSD, QNX and Windows.

This package contains the libmc shared library.

%package devel
Summary: Development files for libmc
...
for developing software which uses the libmc library.
...
- add a URL for where to find libmc.
